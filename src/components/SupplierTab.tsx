  ...
  return (
    <div className={styles.tabContent}>
      <div className={styles.supplierCard}>
        <div className={styles.supplierHeader}>
          ...
          <div className={styles.supplierInfo}>
            ...
            <div className={styles.supplierRating}>
              ...
              <span className={styles.ratingReviews}>(234 reviews)</span>
            </div>
          </div>
        </div>
        ...
        <div className={styles.otherMaterialsSection}>
          <h4>Other Materials from This Supplier</h4>
          <div className={styles.materialsGrid}>
            <div className={styles.materialCard} onClick={() => handleMaterialClick("Sodium Lauryl Sulfoacetate")}>
              <h5>Sodium Lauryl Sulfoacetate</h5>
              <p>Mild surfactant</p>
            </div>
            <div className={styles.materialCard} onClick={() => handleMaterialClick("Cetearyl Alcohol")}>
              <h5>Cetearyl Alcohol</h5>
              <p>Emulsifier</p>
            </div>
            <div className={styles.materialCard} onClick={() => handleMaterialClick("Glyceryl Stearate")}>
              <h5>Glyceryl Stearate</h5>
              <p>Emollient</p>
            </div>
            <div className={styles.materialCard} onClick={() => handleMaterialClick("Xanthan Gum")}>
              <h5>Xanthan Gum</h5>
              <p>Thickener</p>
            </div>
          </div>
          <button className={styles.viewAllButton} onClick={handleViewAllMaterials}>
